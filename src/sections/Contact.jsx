...
const ContactSection = ({ variant = "home" }) => {
    ...
    return (
        <section id="Contact"
            className={`w-full relative z-60  ${isHome ? "bg-[#13172A] py-24" : "bg-transparent"
                }`}
        >
            <div className="max-w-6xl mx-auto rounded-2xl overflow-hidden shadow-lg grid grid-cols-1 md:grid-cols-5">
                ...
                <div className="md:col-span-2 bg-blue-600 p-10 text-white">
                    ...
                    <p className="text-sm font-normal mb-8 leading-relaxed">
                    ...
                    <form className="space-y-4">
                        <input
                            type="text"
                            placeholder="Name"
                            className="w-full bg-transparent px-2 py-3 border-b border-white/40 outline-none placeholder:text-white/70"
                        />
                        ...
                        <button
                            type="submit"
                            className="bg-[#9EC6FA] text-black cursor-pointer font-medium px-7 py-2 rounded-lg hover:bg-white transition"
                        >
                            Submit
                        </button>
                    </form>
                ...
                {/* RIGHT SIDE (INFO) */}
                <div className="md:col-span-3 bg-white p-14 flex flex-col justify-between">

                    {/* MAP IMAGE */}
                    <img
                        src="/images/Maps.png"
                        alt="Map"
                        className="rounded-xl max-h-56 object-cover mb-8"
                    />

                    {/* CONTACT INFO */}
                    <div className="space-y-3 text-md text-black mb-6">
