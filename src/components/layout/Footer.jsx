...
const Footer = () => {
    return (
        <footer className="bg-[#050b1e] text-gray-400 pt-16 md:pt-20">
            <div className="max-w-7xl mx-auto px-5 md:px-10 flex flex-col md:flex-row justify-between gap-12">
            ...
            <div className="border-t border-white mt-12 mx-5 md:mx-20"></div>
